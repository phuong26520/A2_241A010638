package vn.edu.vhu.ltdd.a2_241a010638;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "A2_241A010638";
    ...
    private static final String KEY_STOP_WHEN_BACKGROUND = "stopWhenBackground";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            cbStopWhenBackground.setChecked(savedInstanceState.getBoolean(KEY_STOP_WHEN_BACKGROUND));
    ...
    private long elapsed() {
        ...
        return accumulated + (SystemClock.elapsedRealtime() - startTime);
    }
    ...
    private void updateLaps() {
        ...
        for (int i = 0; i < laps.size(); i++) {
            ...
            lap.setText(String.format(Locale.getDefault(), "%s: %s", i + 1, laps.get(i)));
            lap.setTextSize(16);
            lap.setPadding(0, 8, 0, 8);
            lapContainer.addView(lap);
        }
    }
    ...
    protected void onStop() {
        super.onStop();
        if (cbStopWhenBackground.isChecked() && running) {
            pauseStopwatch();
            Log.d(TAG, "NC2: tự động tạm dừng khi Activity ra nền");
        }
        Log.d(TAG, "onStop");
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(KEY_STOP_WHEN_BACKGROUND, cbStopWhenBackground.isChecked());
